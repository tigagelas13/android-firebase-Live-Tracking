...
import com.example.androidrealtimelocation2019.Adapter.MessageAdapter;
import com.example.androidrealtimelocation2019.Model.Chat;
...
import com.example.androidrealtimelocation2019.Notifications.Client;
import com.example.androidrealtimelocation2019.Notifications.Data;
...
public class MessageActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_send = findViewById(R.id.btn_sand);
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                profile_image.setImageResource(R.drawable.ic_baseline_motorcycle_24);
    ...
    private void sendNotifiaction(String receiver, final String username, final String message){
        DatabaseReference tolens = FirebaseDatabase.getInstance().getReference("Tokens");
        Query query = tolens.orderByKey().equalTo(receiver);
        query.addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                for (DataSnapshot snapshot : dataSnapshot.getChildren()){
                    Token token = snapshot.getValue(Token.class);
                    Data data = new Data(fuser.getUid(),R.drawable.ic_baseline_motorcycle_24, username+": "+message,"New Message",
                            userid);
